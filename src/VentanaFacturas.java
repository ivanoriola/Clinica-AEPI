...
public class VentanaFacturas extends JFrame {
    ...
    public VentanaFacturas() {
        ...
        String column_names[] = {"IdFactura", "Precio"};
            ...
            public void actionPerformed(ActionEvent ae) {
                if (nombreTextField.getText().equals("")) {
                    ...
                    try {
                        ...
                        String sql = "SELECT idFactura, Precio FROM facturas JOIN datos ON facturas.idPaciente = datos.idPaciente WHERE Nombre = \"" + nombreTextField.getText() + "\"";
